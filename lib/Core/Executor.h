...
private:
  ...
  template<typename... Ts>
  std::string model_printf_base_helper_va(uint64_t* &s_offset, const std::string& reason, char type, const std::string& ff, const std::string& out, __va_list_tag* lst, Ts... ts);

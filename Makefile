...
all: klee $(KLEE_LINK_LIBS) $(KLEE_BITCODE) $(RUN_DIR)/lib/main.cpp.o
...
klee:
	...
	$(MAKE) -C $(BUILD_DIR)/build/klee/ || echo 'ignore error'
...
$(RUN_DIR)/lib/main.cpp.o: $(BUILD_DIR)/build/klee/tools/klee/CMakeFiles/klee.dir/main.cpp.o klee
	cp $< $@
